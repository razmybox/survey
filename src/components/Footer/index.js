      ...
      <div className="text-gray-100 bg-gray-800">
        <div className="max-w-3xl mx-auto py-6">
          <h1 className="text-center text-lg lg:text-2xl">
            Join other subscribers and never miss <br /> out on new tips and
            opportunities.
          </h1>
            ...
            <div className="bg-white rounded-md">
              <div className="flex- flex-wrap justify-between md:flex-row rounded">
                ...
                <button
                  ...
                  className=" m-1 p-2 text-sm bg-gray-800 rounded font-semibold uppercase lg:w-auto hover:bg-gray-700"
                >
                  subscribe
                </button>
              </div>
